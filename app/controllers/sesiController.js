...
const getSesiByPemateri = (req, res) => {
  sesiService
    .getSesiByPemateri(req.params.pemateri)
    .then((sesis) => {
      res.status(200).json({
        status: "success",
        message: "Sesi retrieved successfully",
...
const getSesiByTanggal = (req, res) => {
  sesiService
    .getSesiByTanggal(req.params.tanggal)
    .then((sesis) => {
      res.status(200).json({
        status: "success",
        message: "Sesi retrieved successfully",
...
const updateSesi = (req, res) => {
  sesiService
    .updateSesi(req.params.id, req.body)
    .then((sesi) => {
      res.status(200).json({
        status: "success",
