...
const getSeatingById = (req, res) => {
  seatingService.getSeatingById(req.params.id)
    .then((seating) => {
    res.status(200).json({
      status: "success",
      message: "Seating retrieved successfully",
...
const getSeatingBySesi = (req, res) => {
  seatingService.getSeatingBySesi(req.params.sesi)
    .then((seatings) => {
    res.status(200).json({
      status: "success",
      message: "Seating retrieved successfully",
...
const getSeatingByKetersediaan = (req, res) => {
  seatingService.getSeatingByKetersediaan(req.params.ketersediaan)
    .then((seatings) => {
    res.status(200).json({
      status: "success",
      message: "Seating retrieved successfully",
...
const getSeatingByBaris = (req, res) => {
  seatingService.getSeatingByBaris(req.params.baris)
    .then((seatings) => {
    res.status(200).json({
      status: "success",
      message: "Seating retrieved successfully",
...
const updateSeating = (req, res) => {
  ...
  const seating = req.body;
  seatingService.updateSeating(id, seating)
    .then((updatedSeating) => {
    res.status(200).json({
      status: "success",
